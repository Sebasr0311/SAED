...
public class ScriptRunnerTest {
    ...
    public void runScript() {
        try (Connection conn = dataSource.getConnection(); Statement stmt = conn.createStatement()) {
            ...
            try { stmt.execute("ALTER TABLE PERSONAS MODIFY ID_PERSONA GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 1000)"); } catch(Exception e){}
            try { stmt.execute("ALTER TABLE USUARIOS MODIFY ID_USUARIO GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 1000)"); } catch(Exception e){}
            try { stmt.execute("ALTER TABLE USUARIO_ASIGNACIONES MODIFY ID_ASIGNACION GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 1000)"); } catch(Exception e){}
