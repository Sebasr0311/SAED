...
public class ScriptRunnerTest {
    ...
    public void runScript() {
        try (Connection conn = dataSource.getConnection(); Statement stmt = conn.createStatement()) {
            ...
            try { stmt.execute("INSERT INTO PERSONAS (ID_PERSONA, ID_TIPO_DOCUMENTO, NUMERO_DOCUMENTO, TIPO_PERSONA, PRIMER_NOMBRE, PRIMER_APELLIDO, EMAIL) VALUES (1, 1, '000000000', 'NATURAL', 'ADMIN', 'GLOBAL', 'admin_global@saed.com')"); } catch(Exception e){}
            try { stmt.execute("INSERT INTO USUARIOS (ID_USUARIO, ID_PERSONA, NOMBRE_USUARIO, EMAIL, HASH_PASSWORD, ESTADO) VALUES (1, 1, 'admin_global', 'admin_global@saed.com', '$2a$10$Y8yWwG2uR38jM8eIq0f6oOV3/1vM7Z13GkIefw7U9M/P0FqX3q4P3', 'ACTIVO')"); } catch(Exception e){}
            try { stmt.execute("INSERT INTO ADMINISTRADORES_SAED (ID_USUARIO, ESTADO) VALUES (1, 'ACTIVO')"); } catch(Exception e){}
            try { stmt.execute("UPDATE USUARIOS SET HASH_PASSWORD = '$2a$10$Y8yWwG2uR38jM8eIq0f6oOV3/1vM7Z13GkIefw7U9M/P0FqX3q4P3' WHERE ID_USUARIO = 1"); } catch(Exception e){}
            ...
            // Fix sequence collision for IDENTITY columns
            try { stmt.execute("ALTER TABLE PERSONAS MODIFY (ID_PERSONA GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH LIMIT VALUE))"); } catch(Exception e){}
            try { stmt.execute("ALTER TABLE USUARIOS MODIFY (ID_USUARIO GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH LIMIT VALUE))"); } catch(Exception e){}
            try { stmt.execute("ALTER TABLE USUARIO_ASIGNACIONES MODIFY (ID_ASIGNACION GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH LIMIT VALUE))"); } catch(Exception e){}
