...
public class AuditoriaController {
    ...
    public ApiResponse<List<Map<String, Object>>> listar(
        ...
        String roleScope = ctx.getRoleScope();
        ...
        if (!"SUPERADMIN".equals(roleCode)) {
            if ("ORGANIZACION".equals(roleScope) || "ADMIN_ORGANIZACION".equals(roleCode)) {
                sb.append(" AND ID_ORGANIZACION = :ctxOrgId");
                params.addValue("ctxOrgId", ctx.getOrganizationId());
            } else if ("PROPIEDAD".equals(roleScope) || "ADMIN_PROPIEDAD".equals(roleCode)) {
                sb.append(" AND ID_PROPIEDAD = :ctxPropId");
                params.addValue("ctxPropId", ctx.getPropertyId());
            }
        }
    ...
    public ApiResponse<List<Map<String, Object>>> estadisticas() {
        ...
        StringBuilder sb = new StringBuilder("SELECT ENTIDAD, ACCION, COUNT(*) AS TOTAL, " +
        ...
        sb.append(" GROUP BY ENTIDAD, ACCION ORDER BY TOTAL DESC");
    ...
    public ApiResponse<Map<String, Object>> detalle(@PathVariable Long id) {
        ...
        StringBuilder sb = new StringBuilder("SELECT * FROM AUDITORIA_LOG WHERE ID_LOG = :id");
        ...
        List<Map<String, Object>> rows = jdbcTemplate.queryForList(sb.toString(), params);
