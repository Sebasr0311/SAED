...
public class ProductionSchemaInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        initTriggerAsignacionValidaScope();
    ...
    private void initTriggerAsignacionValidaScope() {
        try {
            jdbcTemplate.execute("""
                ...
                END;
            """);
            log.info("[SchemaInit] Trigger TRG_ASIGNACION_VALIDA_SCOPE verificado para soporte de administradores inactivos.");
        } catch (Exception e) {
            log.warn("[SchemaInit] Aviso al actualizar TRG_ASIGNACION_VALIDA_SCOPE: {}", e.getMessage());
        }
    }
}
