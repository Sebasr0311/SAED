    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            runSqlSafe("INSERT INTO USUARIO_ASIGNACIONES (ID_ASIGNACION, ID_USUARIO, ID_ROL, ESTADO, FECHA_INICIO) " +
                   "SELECT 101, 1, (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'SUPERADMIN'), 'ACTIVA', TRUNC(SYSDATE) FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM USUARIO_ASIGNACIONES WHERE ID_USUARIO = 1 AND ID_ROL = (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'SUPERADMIN'))");
            ...
            runSqlSafe("INSERT INTO USUARIO_ASIGNACIONES (ID_ASIGNACION, ID_USUARIO, ID_ROL, ID_ORGANIZACION, ID_PROPIEDAD, ESTADO, FECHA_INICIO) " +
                   "SELECT 102, 2, (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'ADMIN_PROPIEDAD'), 1, 1, 'ACTIVA', TRUNC(SYSDATE) FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM USUARIO_ASIGNACIONES WHERE ID_USUARIO = 2 AND ID_ROL = (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'ADMIN_PROPIEDAD'))");

            runSqlSafe("INSERT INTO USUARIO_ASIGNACIONES (ID_ASIGNACION, ID_USUARIO, ID_ROL, ID_ORGANIZACION, ID_PROPIEDAD, ESTADO, FECHA_INICIO) " +
                   "SELECT 103, 3, (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'PORTERO'), 1, 1, 'ACTIVA', TRUNC(SYSDATE) FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM USUARIO_ASIGNACIONES WHERE ID_USUARIO = 3 AND ID_ROL = (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'PORTERO'))");
            ...
            runSqlSafe("INSERT INTO USUARIO_ASIGNACIONES (ID_ASIGNACION, ID_USUARIO, ID_ROL, ID_ORGANIZACION, ID_PROPIEDAD, ID_UNIDAD, ESTADO, FECHA_INICIO) " +
                   "SELECT 104, 4, (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'RESIDENTE'), 1, 1, 1, 'ACTIVA', TRUNC(SYSDATE) FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM USUARIO_ASIGNACIONES WHERE ID_USUARIO = 4 AND ID_ROL = (SELECT ID_ROL FROM ROLES WHERE CODIGO = 'RESIDENTE'))");
