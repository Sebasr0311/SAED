...
/**
 * DTO de solicitud de creación de proveedor (GAP-F9-01).
 * NOTA CRÍTICA DE SEGURIDAD: idOrganizacion se excluye intencionalmente de este payload
 * para evitar Parameter Tampering. Se resuelve de forma determinista desde SaedContextHolder.
 */
