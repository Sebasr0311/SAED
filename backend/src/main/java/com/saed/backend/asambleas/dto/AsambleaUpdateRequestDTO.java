...
public class AsambleaUpdateRequestDTO {
    ...
    public AsambleaUpdateRequestDTO() {}

    public AsambleaUpdateRequestDTO(String tipo, String modalidad, String titulo,
                                    Integer convocatoriaNumero, String fechaHoraPrimeraConv,
                                    String fechaHoraSegundaConv, String lugarOEnlace,
                                    String ordenDelDia, BigDecimal quorumRequeridoPct, Long idDocumento) {
        this.tipo = tipo;
    ...
    public static class Builder {
        ...
        public AsambleaUpdateRequestDTO build() {
            return new AsambleaUpdateRequestDTO(tipo, modalidad, titulo, convocatoriaNumero,
                    fechaHoraPrimeraConv, fechaHoraSegundaConv, lugarOEnlace, ordenDelDia,
                    quorumRequeridoPct, idDocumento);
        }
    }
