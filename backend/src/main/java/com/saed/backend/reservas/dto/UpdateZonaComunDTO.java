...
/**
 * DTO para la actualización de zonas comunes en una copropiedad (GAP-F8-05).
 * El idZona y el idPropiedad no son editables mediante el payload de solicitud.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class UpdateZonaComunDTO {
    ...
    // Campos protegidos e inmutables vía payload
    private Long idZona;
    private Long idPropiedad;

    public UpdateZonaComunDTO() {}

    public UpdateZonaComunDTO(String nombre, String tipo, Integer aforoMaximo, Object requiereReserva, BigDecimal costoReserva, String estado) {
        this.nombre = nombre;
        this.tipo = tipo;
