...
export function TenantProvider({ children }) {
  ...
  const value = useMemo(
    () => ({
      ...
      activeOrgName: activeAssignment?.nombreOrganizacion ?? null,
      activePropertyName: activeAssignment?.nombrePropiedad ?? null,
      activeUnitNumber: activeAssignment?.identificadorUnidad ?? null,
      canSwitchTenant,
      selectAssignment,
      loading,
      error,
