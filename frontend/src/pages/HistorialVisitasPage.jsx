...
async function exportarExcel(visitas, fechaInicio, fechaFin) {
  ...
  aoa[r] = [
    ...
    S('Residente', estilos.headerTabla), S('Entrada', estilos.headerTabla), S('Salida', estilos.headerTabla), S('Veh�culo', estilos.headerTabla),
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Registro hist�rico de visitas"
        action={
          <Button
            variant="outline"
      ...
      <Modal open={!!detalle} onClose={() => setDetalle(null)} title="Detalle de Visita" size="md">
        ...
        {detalle && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <div className="detail-row">
              <span>Salida</span>
              <span>{formatDate(detalle.fechaSalida) || 'A�n dentro'}</span>
            </div>
