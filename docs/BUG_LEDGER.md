...
| **BE-003** | **P2** | Auditoría | Mutaciones | `*Service.java` | Varios | Mutaciones de negocio no registran en `AUDITORIA_LOG`. | Falta de interceptor transversal. | `OPEN` | Planificado para Fase 5 |
...
| **DB-001** | **P1** | Base de Datos | Migraciones | `database/migrations/` | 18 archivos | Migraciones fragmentadas con versiones duplicadas. | Acumulación de parches SQL. | `OPEN` | Planificado para Fase 4 |
