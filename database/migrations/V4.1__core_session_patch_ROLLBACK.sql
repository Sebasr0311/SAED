-- V4.1__core_session_patch_ROLLBACK.sql
-- Restaura el cuerpo de PKG_SAED_SESSION y PKG_SAED_SECURITY_RLS a su estado exacto en V3.9
...
-- 3. Restaurar PKG_SAED_SECURITY_RLS
CREATE OR REPLACE PACKAGE BODY SAED_V39_FINAL_TEST.PKG_SAED_SECURITY_RLS AS
    ...
    BEGIN
        RETURN '1=0'; -- En V3.9 original, FN_FILTRO_GLOBAL_MUTATE fallaba en devolver 1=0 al inicio. Espera, verifiquemos su definicion.
