-- V4.3__person_rls_patch.sql
-- Resolves physical incompatibility bugs from V3.9 Baseline for SUPERADMIN RLS bypass and missing RLS for PERSONAS
ALTER SESSION SET CURRENT_SCHEMA = SAED_V39_FINAL_TEST;
...
BEGIN
    DBMS_RLS.ADD_GROUPED_POLICY(
        ...
        policy_name              => '"POL_RLS_ORG_PERSONAS"',
